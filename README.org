...
The precise use-package declaration that I use (with elpaca) may be found in my [[https://github.com/ultronozm/emacsd/blob/main/init-latex.el][the LaTeX part of my config]].
